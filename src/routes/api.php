...
Route::get('/mail/verify/{user_id}', 'Auth\VerificationController@verify')->name('verification.verify');
Route::post('/mail/resend', 'Auth\VerificationController@resend')->name('verification.resend');
